<?php 	
		...
		header("Access-Control-Allow-Headers: Origin, X-Requested-With, Content-Type, Accept");
			...
			if(isset($_GET['s']) and strlen($_GET['s'])!=0){
			$s=$_GET['s'];
			$req = pg_query($connection,"SELECT tomato.Jardin.id,tomato.Jardin.icon,tomato.Jardin.adresse,tomato.Jardin.info,tomato.Jardin.description,tomato.Jardin.photo,tomato.Jardin.nom,tomato.Jardin.ville,tomato.Jardin.code,tomato.utilisateur.pseudo,tomato.utilisateur.photo as photoProprio,ST_AsGeoJSON(geom) as geoJ FROM tomato.Jardin,tomato.utilisateur where (code='$s' or ville='$s' or proprio='$s' or adresse='$s') and tomato.Jardin.proprio=tomato.utilisateur.email"); 
			}
			else{
			$pol="SELECT tomato.Jardin.id,tomato.Jardin.icon,tomato.Jardin.adresse,tomato.Jardin.info,tomato.Jardin.description,tomato.Jardin.photo,tomato.Jardin.nom,tomato.Jardin.ville,tomato.Jardin.code,tomato.utilisateur.pseudo,tomato.utilisateur.photo as photoProprio,ST_AsGeoJSON(geom) as geoJ FROM  tomato.Jardin, tomato.utilisateur where tomato.Jardin.proprio=tomato.utilisateur.email";
